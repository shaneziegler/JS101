...
// To highlight a word, enclose the word with two asterisks ('**') on each side and 
...
function searchWord(word, text) {
  let replacementWord = '***' + word.toUpperCase() + '***';

  let reg = new RegExp('\\b' + word + '\\b','gi');
  return text.replaceAll(reg, replacementWord);
}

// let text = 'Sed is the word that sed wants use to notsed or how about noSed?';